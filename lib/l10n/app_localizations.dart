...
abstract class AppLocalizations {
  ...
  /// No description provided for @amana.
  ///
  /// In en, this message translates to:
  /// **'Amana'**
  String get amana;
  ...
  /// No description provided for @timelineCheckedIn.
  ///
  /// In en, this message translates to:
  /// **'Checked in'**
  String get timelineCheckedIn;

  /// No description provided for @timelineCheckedOut.
  ///
  /// In en, this message translates to:
  /// **'Checked out'**
  String get timelineCheckedOut;
}
